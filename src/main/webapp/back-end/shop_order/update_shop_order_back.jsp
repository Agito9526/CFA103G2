...
<table>
	...
	<tr>
		<td>出貨方式:</td>
		<td><input type="TEXT" name="shop_order_shipment" size="45" value="<%=soVO.getShop_order_shipment()%>" /></td>
	</tr>
	<tr>
		<td>運費:</td>
		<td><input type="TEXT" name="shop_order_ship_fee" size="45" value="<%=soVO.getShop_order_ship_fee()%>" /></td>
	</tr>
	<tr>
		<td>總金額:</td>
		<td><input type="TEXT" name="shop_order_amount" size="45" value="<%=soVO.getShop_order_amount()%>" /></td>
	</tr>
	<tr>
		<td>付款方式:</td>
		<td><input type="TEXT" name="shop_order_payment" size="45" value="<%=soVO.getShop_order_payment()%>" /></td>
	</tr>
		<tr>
	...
	<tr>
		<td>出貨日期:</td>
		<td><input name="shop_order_ship_date" id="f_date1" type="text" ></td>
	</tr>
	<tr>
		<td>貨運追蹤號碼:</td>
		<td><input type="TEXT" name="shop_order_track_no" size="45" value="<%=soVO.getShop_order_track_no()%>" /></td>
	</tr>
	<tr>
		<td>訂單狀態:</td>
		<td><input type="TEXT" name="shop_order_status" size="45" value="<%=soVO.getShop_order_status()%>" /></td>
	</tr>
...
<input type="hidden" name="shop_order_date" value="<%=soVO.getShop_order_date()%>">
<input type="hidden" name="shop_order_memo" value="<%=soVO.getShop_order_memo()%>">
